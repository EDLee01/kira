import { MagiConfig, ProviderConfig } from "../config.ts";
import { FetchLike } from "./http.ts";
import { ProviderAdapter } from "./ir.ts";
import { MessagesCompatibleAdapter } from "./messages-compatible.ts";
