...
import { executeConfigTool, ConfigToolInputSchema, parseConfigToolInput } from "./config-tool.ts";
import {
  addCronJob,
  applyCronUpdate,
  CRON_CREATE_SCHEMA,
...
import { createUnifiedDiff, editWorkspaceFile, readWorkspaceFile, writeWorkspaceFile } from "./files.ts";
import {
  checkoutGitBranch,
  createGitBranch,
  getGitDiff,
...
import { executeFileMove, formatFileMoveResult, FileMoveInputSchema, parseFileMoveInput } from "./file-move.ts";
import { executeFileDelete, FileDeleteInputSchema, formatFileDeleteResult, parseFileDeleteInput } from "./file-delete.ts";
import { DirCreateInputSchema, executeDirCreate, formatDirCreateResult, parseDirCreateInput } from "./dir-create.ts";
import { DirListInputSchema, executeDirList, formatDirListResult, parseDirListInput } from "./dir-list.ts";
import { executeProcessList, formatProcessListResult, parseProcessListInput, ProcessListInputSchema } from "./process-list.ts";
import { executeKillProcess, formatKillProcessResult, KillProcessInputSchema, parseKillProcessInput } from "./kill-process.ts";
import { EnvironmentInputSchema, executeEnvironment, formatEnvironmentResult, parseEnvironmentInput } from "./environment.ts";
import { DiskUsageInputSchema, executeDiskUsage, formatDiskUsageResult, parseDiskUsageInput } from "./disk-usage.ts";
import { executeSystemInfo, formatSystemInfoResult, parseSystemInfoInput, SystemInfoInputSchema } from "./system-info.ts";
import { executeHttpRequest, formatHttpRequestResult, HttpRequestInputSchema, parseHttpRequestInput } from "./http-request.ts";
import { DownloadFileInputSchema, executeDownloadFile, formatDownloadFileResult, parseDownloadFileInput } from "./download-file.ts";
import { executeJsonQuery, formatJsonQueryResult, JsonQueryInputSchema, parseJsonQueryInput } from "./json-query.ts";
import { ArchiveCreateInputSchema, executeArchiveCreate, formatArchiveCreateResult, parseArchiveCreateInput } from "./archive-create.ts";
import { ArchiveExtractInputSchema, executeArchiveExtract, formatArchiveExtractResult, parseArchiveExtractInput } from "./archive-extract.ts";
import { executeGitBranchDelete, formatGitBranchDeleteResult, GitBranchDeleteInputSchema, parseGitBranchDeleteInput } from "./git-branch-delete.ts";
import { executeGitStash, formatGitStashResult, GitStashInputSchema, parseGitStashInput } from "./git-stash.ts";
import { executeGitReset, formatGitResetResult, GitResetInputSchema, parseGitResetInput } from "./git-reset.ts";
import { executeFileFind, FileFindInputSchema, formatFileFindResult, parseFileFindInput } from "./file-find.ts";
import { executeHeadTail, formatHeadTailResult, HeadTailInputSchema, parseHeadTailInput } from "./head-tail.ts";
import { executeTextStats, formatTextStatsResult, parseTextStatsInput, TextStatsInputSchema } from "./text-stats.ts";
import { executeTreeView, formatTreeViewResult, parseTreeViewInput, TreeViewInputSchema } from "./tree-view.ts";
import { executeWhoAmI, formatWhoAmIResult, parseWhoAmIInput, WhoAmIInputSchema } from "./whoami.ts";
import { executeNetworkCheck, formatNetworkCheckResult, NetworkCheckInputSchema, parseNetworkCheckInput } from "./network-check.ts";
import { Base64InputSchema, executeBase64, formatBase64Result, parseBase64Input } from "./base64.ts";
import { executeWhich, formatWhichResult, parseWhichInput, WhichInputSchema } from "./which.ts";
import { DateInputSchema, executeDate, formatDateResult, parseDateInput } from "./date.ts";
...
const BUILTIN_TOOLS: RegisteredTool[] = [
      ...
      if (context.sessionId && context.stateRoot) {
        try {
          ...
          if (existsSync(dbPath)) {
            const mod = await import("../session-store.ts");
  ...
  },
  {
    ...
    call: async (input, context) => {
      ...
      return formatAgentToolResult({
        ...
        type: (parsed.subagentType ?? "general") as import("./agent-tool.ts").SubagentType,
  ...
  },
  {
    ...
    call: async (_input, context) => {
      ...
      const { listSkills } = await import("../skills/loader.ts");
